        ...
        <div className={styles.instruction} key={item}>
          ...
          <span className={styles.instructionText}>
            {index === 0 && active === '1' ? (
              <span>
                In this{' '}
                <a href="https://console.statsig.com/" rel="noopener noreferrer" target="_blank">
                  link
                </a>
                {item}.
              </span>
      ...
      <div className={styles.modal}>
        ...
        {active === '1' && (
          <InstructionItems
            ...
            instructions={[
              ', click the setting icon in the right-nav and open the Project setting page.',
              'In the Keys & Environments section, click + Generate New Key.',
              'The Create New Key window appears.',
              'Choose Key Type for the API Key and click Create button.',
            ]}
          />
        )}
        {active === '2' && (
