      ...
      {instructions.map((item, index) => (
        <div className={styles.instruction} key={item}> {/* Changed key to index for uniqueness */}
          ...
          <span className={styles.instructionText}>
            {index === 0 && active === '1' ? (
              <span>
                {item}  <a href="https://yousign.app/auth/integrations/apikeys" target="_blank" rel="noopener noreferrer">link</a>.
              </span>
            ) : (
              item
            )}
        ...
        {active === '2' && (
          <>
            <InstructionItems
              ...
              instructions={['Paste the API Key from your application below:']}
            />
